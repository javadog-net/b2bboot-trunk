...
/**
*@Description 提供给移动端商空视频的接口
*@Author t.c
*@Date 2019-11-08
*/
@RestController
@RequestMapping(value = "/api/mobiles/skmv")
public class MobilesApiSkMvController extends BaseController {
	...
	/** 
	  ...
	  * @return AjaxJson
	  * @author tc
	  * @date  2019年11月8日下午7:35:28
	  */
	@RequestMapping("/findDetailsById")
	public AjaxJson findMVById(@RequestParam(value = "id") String id) {
		...
		try {
			...
			e.printStackTrace();
			logger.info("移动端商空视频详情接口，异常信息："+e.getMessage());
		}
	 ...
	 * @return AjaxJson
	 * @author tc
	 * @date  2019年11月8日上午9:28:04
	 */
	@RequestMapping(value = "/addComment")
	public AjaxJson addComment(@RequestParam(value = "id") String id ,
	 ...
	 * @return AjaxJson
	 * @author tc
	 * @date  2019年11月8日上午9:28:16
	 */
	@RequestMapping(value = "/addLike")
	public AjaxJson addLike(@RequestParam(value = "id") String id) {
		PurchaserAccount purchaserAccount = PurchaserUtils.getPurchaserAccount();
		if (purchaserAccount == null) {
			return AjaxJson.fail("401", "请重新登录！");
		}
