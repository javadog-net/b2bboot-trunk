 ...
 */
@RestController
@RequestMapping("/api/pc/register")
public class PCApiRegisterController extends BaseController {
	@Autowired
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "pctab", value = "官网注册标识", required = true, paramType = "form", dataType = "String"),
