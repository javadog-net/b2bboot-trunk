 ...
 * @version 2018-08-16
 */
public class PurchaserGoodsFavorites extends DataEntity<PurchaserGoodsFavorites> {
	...
	private String logPrice;		// 商品收藏时价格
	...
	public PurchaserGoodsFavorites() {
		super();
	}

	public PurchaserGoodsFavorites(String id){
		super(id);
	}
	...
	@ExcelField(title="商品收藏时价格", align=2, sort=11)
	...
	@ExcelField(title="收藏备注", align=2, sort=12)
