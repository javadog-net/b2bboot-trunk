 ...
 * @version 2018-07-22
 */
public class StoreEvaluate extends DataEntity<StoreEvaluate> {
	...
	private List<GoodsEvaluate> goodsEvaluates;  //商品评价列表

	public List<GoodsEvaluate> getGoodsEvaluates() {
		return goodsEvaluates;
	}

	public void setGoodsEvaluates(List<GoodsEvaluate> goodsEvaluates) {
	...
	public StoreEvaluate(String id){
		super(id);
	}
