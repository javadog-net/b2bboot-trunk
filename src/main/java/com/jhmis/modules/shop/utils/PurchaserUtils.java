...
public class PurchaserUtils {
     ...
     * @return
     */
    public static PurchaserAccount getByLoginNumber(String number){
        PurchaserAccount purchaserAccount = (PurchaserAccount)CacheUtils.get(PURCHASER_CACHE, PURCHASER_ACCOUNT_CACHE_LOGIN_NAME_ + number);
            if (purchaserAccount==null){
                purchaserAccount = purchaserAccountMapper.getByLoginNumber(number);
                if (purchaserAccount==null){
                    return null;
                }
    ...
    public static void clearCache(){
        PurchaserUtils.clearCache(getPurchaserAccount());
    }
     ...
     * @param purchaserAccount
     */
    public static void clearCacheNumber(PurchaserAccount purchaserAccount){
        if(purchaserAccount == null || StringUtils.isEmpty(purchaserAccount.getId())){
            return;
        }
        CacheUtils.remove(PURCHASER_CACHE, PURCHASER_ACCOUNT_CACHE_MENU_LIST + purchaserAccount.getId());
        CacheUtils.remove(PURCHASER_CACHE, PURCHASER_ACCOUNT_CACHE_ID_ + purchaserAccount.getId());
        CacheUtils.remove(PURCHASER_CACHE, PURCHASER_ACCOUNT_CACHE_LOGIN_NAME_ + purchaserAccount.getLoginNum());
    }
     ...
     * @param purchaserAccount
     */
    public static void putCacheNumber(PurchaserAccount purchaserAccount){
        if(purchaserAccount == null || StringUtils.isEmpty(purchaserAccount.getId())){
            return;
        }
        CacheUtils.put(PURCHASER_CACHE, PURCHASER_ACCOUNT_CACHE_ID_ + purchaserAccount.getId(), purchaserAccount);
        CacheUtils.put(PURCHASER_CACHE, PURCHASER_ACCOUNT_CACHE_LOGIN_NAME_ + purchaserAccount.getLoginNum(), purchaserAccount);
    }
