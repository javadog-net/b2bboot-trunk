 ...
 */
package com.jhmis.modules.process.entity.shopproject;
 ...
 * @version 2019-11-04
 */
public class ShopProject extends DataEntity<ShopProject> {
	...
	private String projectsSource;		// 需求来源状态(GN_PRJ_15经销商报备 GN_PRJ_08客户提报)
	
	public ShopProject() {
		super();
	}

	public ShopProject(String id){
		super(id);
	}
