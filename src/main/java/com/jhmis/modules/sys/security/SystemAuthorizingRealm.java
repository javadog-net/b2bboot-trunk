...
import com.jhmis.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		boolean mobile = WebUtils.isTrue(Servlets.getRequest(), FormAuthenticationFilter.DEFAULT_MOBILE_PARAM);
		// 校验登录验证码
		...
		if (user != null) {
			...
			//这里创建一个authenticationInfo，内部会进行校验，不通过校验会以异常形式弹出
			return new SimpleAuthenticationInfo(new Principal(user, token.isMobileLogin(),token.getUserType()),
