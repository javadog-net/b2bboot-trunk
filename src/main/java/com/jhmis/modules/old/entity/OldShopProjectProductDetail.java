 ...
 * @version 2019-12-06
 */
public class OldShopProjectProductDetail extends DataEntity<OldShopProjectProductDetail> {
	...
	private String cjpricesum;		// 供价合计
	private String price;		// 折扣后价格
	private String pricesum;		// 折扣后合计总价
	...
	public OldShopProjectProductDetail() {
		super();
		this.setIdType(IDTYPE_AUTO);
	}

	public OldShopProjectProductDetail(String id){
		super(id);
	}
	...
	@ExcelField(title="供价合计", align=2, sort=5)
	...
	@ExcelField(title="折扣后价格", align=2, sort=6)
	...
	@ExcelField(title="折扣后合计总价", align=2, sort=7)
	...
	@ExcelField(title="productid", align=2, sort=11)
	...
	@ExcelField(title="productname", align=2, sort=12)
	...
	@ExcelField(title="modelcode", align=2, sort=15)
	...
	@ExcelField(title="modelname", align=2, sort=16)
	...
	@ExcelField(title="迭代标识(msgid存在为直单漏斗更新后数据，目的为更新视图所用)", align=2, sort=42)
