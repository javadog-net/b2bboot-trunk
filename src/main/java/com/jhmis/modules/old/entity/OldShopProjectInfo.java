 ...
 * @version 2019-12-06
 */
public class OldShopProjectInfo extends DataEntity<OldShopProjectInfo> {
	...
	private String bindamount;		// 中标金额
	private String indus;		// 所在行业
	...
	private Date canceltime;		// canceltime
	private String bz1;		// 预留字段2
	...
	private String isnewcust;		// 是否新客户
	private String isnewuser;		// 是否新客户
	private String projectsourse;		// 项目来源
	private String isbidloss;		// 是否丢标0中标；1丢标
	private String statusfx;		// 丢标状态分析
	private String bidlossmoney;		// 中标金额
	...
	public OldShopProjectInfo() {
		super();
	}

	public OldShopProjectInfo(String id){
		super(id);
	}

	@ExcelField(title="projectcode", align=2, sort=1)
	...
	@ExcelField(title="contact", align=2, sort=5)
	...
	@ExcelField(title="contmobile", align=2, sort=6)
	...
	@ExcelField(title="所在行业", align=2, sort=11)
	...
	@ExcelField(title="orgid", align=2, sort=13)
	...
	@ExcelField(title="orgname", align=2, sort=14)
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	@ExcelField(title="canceltime", align=2, sort=29)
	...
	@ExcelField(title="预留字段2", align=2, sort=30)
	...
	@ExcelField(title="bz2", align=2, sort=31)
	...
	@ExcelField(title="是否新客户", align=2, sort=47)
	...
	@ExcelField(title="是否新客户", align=2, sort=48)
	...
	@ExcelField(title="项目来源", align=2, sort=49)
	...
	@ExcelField(title="中标金额", align=2, sort=52)
	...
	@ExcelField(title="成交额（万元）", align=2, sort=64)
	...
	@ExcelField(title="迭代标识(msgid存在为直单漏斗更新后数据，目的为更新视图所用)", align=2, sort=65)
