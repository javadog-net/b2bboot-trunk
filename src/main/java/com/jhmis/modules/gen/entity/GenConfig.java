...
public class GenConfig implements Serializable {
    ...
    private List<GenDict> MssqlFieldType;
    ...
    public List<GenDict> getMssqlFieldType() {
        return this.MssqlFieldType;
    }

    public void setMssqlFieldType(List<GenDict> mssqlFieldType) {
        this.MssqlFieldType = mssqlFieldType;
    }
}
