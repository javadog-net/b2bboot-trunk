...
public class GenTableColumn extends DataEntity<GenTableColumn> {
    ...
    public List<String> getSimpleAnnotationList() {
        List<String> list = Lists.newArrayList();
        Iterator<String> var3 = this.getAnnotationList().iterator();
    ...
    public Boolean getIsNotTreeBaseField() {
        return !StringUtils.equals(this.getSimpleJavaField(), "id") && !StringUtils.equals(this.getSimpleJavaField(), "remarks") && !StringUtils.equals(this.getSimpleJavaField(), "createBy") && !StringUtils.equals(this.getSimpleJavaField(), "createDate") && !StringUtils.equals(this.getSimpleJavaField(), "updateBy") && !StringUtils.equals(this.getSimpleJavaField(), "updateDate") && !StringUtils.equals(this.getSimpleJavaField(), "delFlag") && !StringUtils.equals(this.getSimpleJavaField(), "parent") && !StringUtils.equals(this.getSimpleJavaField(), "parentIds") && !StringUtils.equals(this.getSimpleJavaField(), "name") && !StringUtils.equals(this.getSimpleJavaField(), "sort") ? true : false;
    }
