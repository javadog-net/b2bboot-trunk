package com.jhmis.common.beanvalidator;
...
public class RegValidators {
     ...
     * 正则表达式：验证密码
     */
    public static final String REGEX_CIPHERKEY = "^[a-zA-Z0-9]{6,16}$";
    ...
    public static boolean isPassword(String password) {
        return Pattern.matches(REGEX_CIPHERKEY, password);
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(RegValidators.isImgParameter("http://127.0.0.1:8080/ddbuy/c.jpg_1400x20.jpg"));
    }
