...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static boolean copyDirectoryCover(String srcDirName,
		...
		for (int i = 0; i < files.length; i++) {
			// 如果是一个单个文件，则直接复制
			log.info("0000000000000--------"+files[i].getName()+"---------"+files[i].isFile());
			if (files[i].isFile()) {
	 ...
	 */
	public static String calcMd5(String fileName) throws IOException, NoSuchAlgorithmException {
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public static String calcMd5(File f) throws IOException, NoSuchAlgorithmException {
		byte[] buffer = new byte[8192];
		MessageDigest md5 = MessageDigest.getInstance("md5");
		InputStream ins = new FileInputStream(f);
		try {
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public static String calcMd5(InputStream ins) throws NoSuchAlgorithmException, IOException {
		byte[] buffer = new byte[8192];
		MessageDigest md5 = MessageDigest.getInstance("md5");
		int len;
		while ((len = ins.read(buffer)) != -1) {
	 ...
	 * @throws NoSuchAlgorithmException
	 */
	public static String calcMd5(byte[] ins) throws NoSuchAlgorithmException {
		MessageDigest md5 = MessageDigest.getInstance("md5");
		md5.update(ins);
		return DigestUtils.md5Hex(md5.digest());
	}
