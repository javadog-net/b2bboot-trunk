package com.jhmis.common.utils.time;
...
public class DateUtil {
     ...
     * 加一年
     */
    public static Date addYears(@NotNull final Date date, int amount) {
     ...
     * 减一年
     */
    public static Date subYears(@NotNull final Date date, int amount) {
        return DateUtils.addYears(date, -amount);
    }
