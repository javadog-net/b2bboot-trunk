...
public class CacheUtils {
	...
	/**
	 * 写入SYS_CACHE缓存，并设置过期时间
	 * @param key
	 * @param value
	 * @param expireInSec
	 */
	public static void put(Object key, Object value, Integer expireInSec) {
	 ...
	 * @param expireInSec
	 */
	public static void put(String region, Object key, Object value, Integer expireInSec) {
