...
! function(e) {
	...
	n.prototype.cache = o, n.prototype.define = function(e, t) {
		...
		function s(e, t) {
			...
			("load" === e.type || n.test((e.currentTarget || e.srcElement).readyState)) && (o.modules[d] = t, f.removeChild(v),
				function r() {
					return ++m > 1e3 * o.timeout / 4 ? i(d + " is not a valid module") : void(o.status[d] ? c() : setTimeout(r, 4))
				}())
		}

		function c() {
			l.push(layui[d]), e.length > 1 ? y.use(e.slice(1), n, l) : "function" == typeof n && n.apply(layui, l)
		}
		var y = this,
		...
		if (o.modules[d]) ! function g() {
			return ++m > 1e3 * o.timeout / 4 ? i(d + " is not a valid module") : void("string" == typeof o.modules[d] && o.status[
				d] ? c() : setTimeout(g, 4))
		}();
		else {
			var v = t.createElement("script"),
				h = (u[d] ? p + "lay/" : /^\{\/\}/.test(y.modules[d]) ? "" : o.base || "") + (y.modules[d] || d) + ".js";
