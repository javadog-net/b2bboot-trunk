...
;layui.define("layer", function (e) {
    ...
    u.prototype.set = function (e) {
        ...
        a.each(function (e, a) {
            ...
            layui.each(t, function (e, t) {
                var a, l;
                if (a = i.isArray(t) ? n.find('[name^="' + e + '"]') : n.find('[name="' + e + '"]'), a[0]) if (l = a[0].type, "checkbox" === l) {
                    var r = [];
                    r = i.isArray(t) ? t : t.split(","), a.each(function () {
                        i.inArray(this.value, r) > -1 && (this.checked = !0)
                    })
                } else "radio" === l ? a.each(function () {
    ...
    var d = function () {
        ...
        if (layui.each(d, function (e, l) {
            ...
            return r.removeClass(o), (i.inArray("required", c) != -1 || "" != d) && (layui.each(c, function (e, i) {
                ...
                if (a[i]) {
                    ...
                    }(), {tips: 1}) : "alert" === u ? t.alert(f, {title: "提示", shadeClose: !0}) : parent.layer.msg(f, {
                        icon: 5,
                        shift: 6
