				...
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<a class="panelButton" href="${ctx}/shop/purchaser/purchaser"><i
								class="ti-angle-left"></i> 返回</a>
						</h3>
					</div>
					<div class="panel-body">
						<form:form id="inputForm" modelAttribute="purchaser"
							action="${ctx}/shop/purchaser/purchaser/save" method="post"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="companyNum" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class=" input-group" style="width: 100%;">
										<form:input path="areaInfo" htmlEscape="false" class=""
											data-toggle="city-picker" provinceId="provinceId"
											cityId="cityId" districtId="districtId" style="height: 34px;" />
									</div>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:select path="industryId" htmlEscape="false"
										class="form-control">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="companyTel" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="contacts" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="companyNature" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:hidden id="licenceUrl" path="licenceUrl"
										htmlEscape="false" maxlength="255" class="form-control" />
									<%-- <c:if test="${!empty purchaser}">
						<img id="licenceUrl" name="licenceUrl" alt="" src="${purchaser.licenceUrl }">
					</c:if> --%>
									<sys:webupload input="licenceUrl" type="image" multiple="false" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">开户行名称：</label>
								<div class="col-sm-10">
									<form:input path="bankName" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">开户行帐号：</label>
								<div class="col-sm-10">
									<form:input path="bankAccount" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label">开户行帐号：</label>
								<div class="col-sm-10">
									<form:input path="bankAddress" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:input path="invitationCode" htmlEscape="false"
										class="form-control " />
								</div>
							</div>
							<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="auditDesc" htmlEscape="false"  readonly="true"   class="form-control "/>
							...
							<c:if
								test="${fns:hasPermission('shop:purchaser:purchaser:edit') || isAdd}">
...
<!-- <script type="text/javascript">
	window.onload = function() {
		var src = $("#licenceUrl").val();
		alert(src);
		var $imgWrap = $("#webupload_licenceUrl div.imgWrap");
		var t = $("#webupload_licenceUrl div.imgWrap img");
		alert(t);
		debugger;
	}
