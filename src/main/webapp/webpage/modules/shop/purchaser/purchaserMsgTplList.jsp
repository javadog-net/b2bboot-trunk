...
<head>
	...
	<%@include file="purchaserMsgTplList.js" %>
</head>
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="purchaserMsgTpl" class="form form-horizontal well clearfix">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="shop:purchaser:purchaserMsgTpl:add">
				<a id="add" class="btn btn-primary" href="${ctx}/shop/purchaser/purchaserMsgTpl/form" title="消息模板"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="shop:purchaser:purchaserMsgTpl:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="shop:purchaser:purchaserMsgTpl:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="shop:purchaser:purchaserMsgTpl:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/shop/purchaser/purchaserMsgTpl/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="purchaserMsgTplTable"   data-toolbar="#toolbar"></table>
