...
<head>
	...
	<%@include file="purchaserList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">采购商列表</h3>
	</div>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
		<%--	<shiro:hasPermission name="shop:purchaser:purchaser:add">
         ...
         <shiro:hasPermission name="shop:purchaser:purchaser:audit">
			...
			<%--<shiro:hasPermission name="shop:purchaser:purchaser:import">
	...
	<!-- 表格 -->
	<table id="purchaserTable"   data-toolbar="#toolbar"></table>
