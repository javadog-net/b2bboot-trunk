        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <div class="widget-content nopadding">
                    ...
                    <form class="form-horizontal" method="post" action="goodsCategoryMakeHtml.do" name="form" id="form">
                        <input type="hidden" name="ids" id="id" value="${goodsCategory.id }">
                        ...
                        <div class="control-group">
                            <div class="controls" style="margin-left: 190px;">
                                ...
                                <a onclick="location.href='form.do?id=${goodsCategory.id }'" class="btn">不，我要继续编辑此栏目</a>
                            </div>
                        </div>
                    </form>
                </div>
