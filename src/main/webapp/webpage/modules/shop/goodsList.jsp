...
<body>
				...
				<div class="col-sm-4 col-md-3" >
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-2" >
								<button  class="btn btn-default btn-sm"  onclick="jh.openDialog('新建商品目录表', '${ctx}/shop/goodsCategory/form','800px', '500px', $('#goodsCategoryjsTree'))">
	...
	<div id="toolbar">
			<shiro:hasPermission name="shop:goods:add">
				<button id="add" onclick="add(this)" class="btn btn-primary" <%--href="${ctx}/shop/goods/form"--%> title="商品表">
			...
			<shiro:hasPermission name="shop:goods:del">
			   ...
			   <%-- <button id="makeHtml" class="btn btn-success"  onclick="makeHtml()">
	            	<i class="glyphicon glyphicon-plus"></i> 静态化
	        	</button>--%>
			<%--<shiro:hasPermission name="shop:goods:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/shop/goods/import" method="post" enctype="multipart/form-data"
		...
		<%--	<button id="tranche" class="btn btn-warning" onclick="tranche()">
				<i class="fa fa-folder-open-o"></i> 一期数据导入
			</button>--%>
