	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/shop/dealer/dealerMsgTpl"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="dealerMsgTpl" action="${ctx}/shop/dealer/dealerMsgTpl/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>	
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<div id="mailContent">
                          ${fns:unescapeHtml(dealerMsgTpl.mailContent)}
                        </div>
					</div>
				</div>
		<c:if test="${fns:hasPermission('shop:dealer:dealerMsgTpl:edit') || isAdd}">
