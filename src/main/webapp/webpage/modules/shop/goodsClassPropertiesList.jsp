    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="goodsClassProperties"
                                   class="form form-horizontal well clearfix">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="商品品类：">商品品类：</label>
                                <input type="text" class="form-control className" value="" readonly/>

                                <form:hidden path="classId" htmlEscape="false" maxlength="64" class=" form-control"/>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <div id="toolbar">
                ...
                <shiro:hasPermission name="shop:goodsClassProperties:import">
                    <button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
                    <div id="importBox" class="hide">
                        <form id="importForm" action="${ctx}/shop/goodsClassProperties/import" method="post"
            ...
            <!-- 表格 -->
            <table id="goodsClassPropertiesTable" data-toolbar="#toolbar"></table>
