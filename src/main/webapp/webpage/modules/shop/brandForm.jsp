		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jh.post("${ctx}/shop/brand/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="brand" class="form-horizontal">
		<form:hidden path="id"/>
		   ...
		   <tbody>
			...
			<!-- 上传 -->	
				<%--<tr>
					...
					<td class="width-35">
						<form:hidden id="imgUrl" path="imgUrl" htmlEscape="false" maxlength="255" class="form-control"/>
