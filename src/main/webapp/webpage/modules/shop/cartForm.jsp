		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jh.post("${ctx}/shop/cart/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="cart" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right"><font color="red">*</font>店铺ID：</label></td>
					<td class="width-35">
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">产品主图：</label></td>
					<td class="width-35">
					...
					<td class="width-35">
						<form:input path="chooseNum" htmlEscape="false"    class="form-control required"/>
					</td>
				</tr>
		 	</tbody>
		</table>
