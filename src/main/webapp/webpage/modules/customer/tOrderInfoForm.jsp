	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/customer/tOrderInfo"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
		<form:form id="inputForm" modelAttribute="tOrderInfo" action="${ctx}/customer/tOrderInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<c:if test="${fns:hasPermission('customer:tOrderInfo:edit') || isAdd}">
