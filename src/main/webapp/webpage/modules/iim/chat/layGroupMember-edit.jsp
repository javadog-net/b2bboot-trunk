...
<head>
	...
	<script type="text/javascript">
        ...
        function refreshMembers() {
            jh.get("${ctx}/iim/layGroup/memberData?id=${layGroup.id}", function (data) {
                debugger
        ...
        function addMemberToGroup(){
            jh.openUserSelectDialog(true,function (ids) {
                jh.get("${ctx}/iim/layGroup/addUser?ids="+ids+"&groupid=${layGroup.id}", function (result) {
                    if(result.success){
                        refreshMembers()
        ...
        function delFromGroup(id){
            jh.get("${ctx}/iim/layGroup/logout?user.id="+id+"&group.id=${layGroup.id}",function (data) {
				if(data.success){
                    refreshMembers()
				    jh.success(data.msg);
				}
