													...
													<tr>
														<td class="client-avatar">
                                                            <c:if test="${user.photo == null || user.photo==''}">
                                                                <img alt="image" style="width: 50px;max-height: 50px;" src="${ctxStatic}/common/images/flat-avatar.png">
                                                            </c:if>
                                                            <c:if test="${user.photo != null && user.photo!=''}">
                                                                <img alt="image" style="width: 50px;max-height: 50px;" src="/shop${user.photo}">
                                                            </c:if>
                                                        </td>
