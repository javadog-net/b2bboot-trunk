...
<script>
        ...
        function query() {
            ...
            jh.post("${ctx}/tools/sysDataSource/executeSql", $('#inputForm').serialize(), function (data) {
                var datas = [];
                var columns = [{
                    checkbox: true
        ...
        function link() {
            ...
            jh.post("${ctx}/tools/sysDataSource/getTable", $('#inputForm').serialize(), function (data) {
        ...
        function getColumn() {
            ...
            $("#column").html("");
            jh.post("${ctx}/tools/sysDataSource/getColumn", $('#inputForm').serialize(), function (data) {
                var list = data.body.result;
                for(var i=0; i<list.length; i++){
