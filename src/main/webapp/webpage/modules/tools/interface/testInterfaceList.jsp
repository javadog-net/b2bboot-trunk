...
<head>
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/tools/testInterface/form?id=" + row.id;
                        ...
                        jh.confirm('确认要删除该测试接口记录吗？', function(){
                       	jh.loading();
                       	jh.get("${ctx}/tools/testInterface/delete?id="+row.id, function(data){
                   	  		if(data.success){
  ...
  function deleteAll(){
		...
		jh.confirm('确认要删除该测试接口记录吗？', function(){
			jh.loading();  	
			jh.get("${ctx}/tools/testInterface/deleteAll?ids=" + getIdSelections(), function(data){
         	  		if(data.success){
         	  			$('#table').bootstrapTable('refresh');
         	  			jh.success(data.msg);
         	  		}else{
