...
<body class="">
	<nav class="navbar topnav-navbar navbar-fixed-top" role="navigation">
		...
		<div class="collapse navbar-collapse">
			...
			<input id="panduan" type="hidden" value="0" />
			...
			<div class="text-center" style="padding-top:10px;"> 
				<a  href="#">
                    <c:if test="${fns:getUser().photo == null || fns:getUser().photo==''}">
                        <img class="img-circle user-avatar"  src="${ctxStatic}/common/images/flat-avatar.png" class="user-avatar" />
                    </c:if>
                    <c:if test="${fns:getUser().photo != null && fns:getUser().photo!=''}">
                        <img class="img-circle user-avatar"  src="/shop${fns:getUser().photo}" class="user-avatar" />
                    </c:if>
                </a>
...
function changeStyle(){
    $.get('${ctx}/style/adv?url='+window.top.location.href,function(result){
