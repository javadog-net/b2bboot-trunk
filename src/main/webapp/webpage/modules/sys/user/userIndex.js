...
<script type="text/javascript">
		...
		//zTree初始化
				  ...
				  //请求方法
	                ...
	                columns: [{
				        ...
				        formatter:function(value, row , index){
				        	if(value ==''){
				        		return '<img height="40px" src="/shop${ctxStatic}/common/images/flat-avatar.png">';
				        	}else{
				        		return '<img   onclick="jh.showPic(\'/shop'+value+'\')"'+' height="40px" src="/shop'+value+'">';
				        	}
		  ...
		  function deleteAll(ids){
				...
				jh.confirm('确认要删除选中用户吗？',  function(){
					    jh.loading();
		  ...
		  function edit(id){
			  ...
			  jh.openDialog('编辑用户', "${ctx}/sys/user/form?id=" + id,'800px', '680px');
