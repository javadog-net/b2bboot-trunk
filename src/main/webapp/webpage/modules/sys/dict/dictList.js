...
$(document).ready(function() {
                ...
                columns: [{
                    ...
                    events: {
        		        'click .view': function (e, value, row, index) {
        		        	jh.openDialogView('查看字典', '${ctx}/sys/dict/form?id=' + row.id,'800px', '500px');
        		        },
        		        'click .edit': function (e, value, row, index) {
        		        	jh.openDialog('编辑字典', '${ctx}/sys/dict/form?id=' + row.id,'800px', '500px');
        		        },
  ...
  function add(){
	  jh.openDialog('新建字典', '${ctx}/sys/dict/form','800px', '500px')
  }
  ...
  function edit(id){
	  ...
	  jh.openDialog('编辑字典', "${ctx}/sys/dict/form?id=" + id,'800px', '500px')
  ...
  function del(ids){
		...
		jh.loading();
		jh.confirm('确认要删除选中字典吗？',  function(){
...
$(document).ready(function() {
	var $dictValueTable =	$('#dictValueTable').bootstrapTable({
                ...
                columns: [{
                    ...
                    events: {
                    	 'click .edit': function (e, value, row, index) {
                    		 ...
                    		 jh.openDialog('编辑键值', '${ctx}/sys/dict/dictValueForm?dictTypeId=' + $("#dictTypeId").val()+"&dictValueId="+row.id,'800px', '500px', $dictValueTable);
            		        },
        		        'click .del': function (e, value, row, index) {
        		        	
        		        	jh.confirm('确认要删除键值吗？',function(){
        		        		jh.loading();
		  ...
		  $("#dictValueButton").click(function(){
				...
				jh.openDialog('添加键值', '${ctx}/sys/dict/dictValueForm?dictTypeId=' + $("#dictTypeId").val(),'800px', '500px', $dictValueTable);
			});
