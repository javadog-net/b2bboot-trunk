...
<body>
	...
	<div class="row">
		    ...
		    <div  id="right" class="panel panel-default col-sm-6" style="display:none">
				<div class="panel-heading">
					<h3 class="panel-title"><a href="#" id="subfadeout" title="收起"><i class="fa fa-angle-double-left"></i> </a><label>键值列表，所属类型: </label><font id="dictTypeLabel"></font><input type="hidden" id="dictTypeId"/></h3>
				</div>
				<div class="panel-body">
