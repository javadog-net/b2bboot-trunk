...
<head>
	...
	<%@include file="shopMsgCustcodeOrderList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title">经销商订单列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="shopMsgCustcodeOrder" class="form form-horizontal well clearfix">
			<div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="订单来源：">订单来源：</label>
				 <form:select path="fromSource"  class="form-control m-b">
					 <form:option value="" label="请选择订单来源"/>
					 <form:options items="${fns:getDictList('order_from_source')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				 </form:select>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="订单状态：">订单状态：</label>
				 <form:select path="cancelFlag"  class="form-control m-b">
					 <form:option value="" label="请选择订单来源"/>
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="承接方式：">承接方式：</label>
				 <form:select path="underTake"  class="form-control m-b">
					 ...
					 <form:options items="${fns:getDictList('order_undertake')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				 </form:select>
			</div>
				<div class="col-xs-12 col-sm-6 col-md-4">
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="process:shopmsgorder:shopMsgCustcodeOrder:add">
				<a id="add" class="btn btn-primary" href="${ctx}/process/shopmsgorder/shopMsgCustcodeOrder/form" title="经销商订单"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="process:shopmsgorder:shopMsgCustcodeOrder:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="process:shopmsgorder:shopMsgCustcodeOrder:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="process:shopmsgorder:shopMsgCustcodeOrder:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/process/shopmsgorder/shopMsgCustcodeOrder/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="shopMsgCustcodeOrderTable"   data-toolbar="#toolbar"></table>
