	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/process/shopmsg/shopMsg/returnList"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		<div class="panel-body">
			...
			<div class="">
				...
				<table class="table table-striped table-hover table-bordered">
					<h3 style="font-size: 17px; font-weight: bold; margin-bottom: 10px;">400回传信息</h3>
					<tbody>
					<tr class="active">
						<td>需求状态:</td>
						<td>
                            <select path="state" class="form-control required state">
						...
						<td>
                            <div class="form-group">
                                <div class="col-xs-12">
                                    <div class='input-group date' id='bindtime' >
                                        <input type='text'  name="bindtime" class="form-control bindtime"  />
					...
					<tr class="">
						<td>中标金额(万元):</td>
						<td><input type="text" class="form-control required cjmoney isFloatGteZero"></td>
						<td>备注 :</td>
						<td>
                            <textarea name="" id="" rows="6" maxlength="2000" class="form-control required memo" >
                            </textarea>
						</td>
					</tr>
					<tr class="">
						<td>操作:</td>
						<td>
							<shiro:hasPermission name="process:shopmsg:shopMsg:hicBack">
							<a class="btn btn-success hicback" onclick="hicback();">回传</a>
							</shiro:hasPermission>
						</td>
						<td></td>
						<td>
...
<script>
    ...
    function hicback(){
        ...
        var cjmoney = $(".cjmoney").val();
        var memo = $(".memo").val();
        var backid = '${shopMsg.id}';
        if(state==""){
        	jh.error("需求状态不能为空");
        	return;
		}
        ...
        jh.post("${ctx}/process/shopmsg/shopMsg/hicBack",data,function(data){
            if(data.success){
                layer.alert("操作成功",{icon:1},function(){
                    window.location.href = "${ctx}/process/shopmsg/shopMsg/returnList";
                })
            }else{
